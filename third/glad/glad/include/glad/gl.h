/**
 * Loader generated by glad 2.0.0-beta on Sat May 18 16:27:43 2019
 *
 * Generator: C/C++
 * Specification: gl
 * Extensions: 599
...
typedef void (GLAD_API_PTR *PFNGLGETINTERNALFORMATSAMPLEIVNVPROC)(GLenum   target, GLenum   internalformat, GLsizei   samples, GLenum   pname, GLsizei   bufSize, GLint  * params);
...
typedef void (GLAD_API_PTR *PFNGLGETPROGRAMRESOURCEFVNVPROC)(GLuint   program, GLenum   programInterface, GLuint   index, GLsizei   propCount, const  GLenum  * props, GLsizei   bufSize, GLsizei  * length, GLfloat  * params);
...
typedef GLint (GLAD_API_PTR *PFNGLQUERYRESOURCENVPROC)(GLenum   queryType, GLint   tagId, GLuint   bufSize, GLint  * buffer);
...
typedef void (GLAD_API_PTR *PFNGLVDPAUGETSURFACEIVNVPROC)(GLvdpauSurfaceNV   surface, GLenum   pname, GLsizei   bufSize, GLsizei  * length, GLint  * values);
